...
def train_data_sample(project, precentage):
    ...
    #编码
    file = open(r'C:\Users\wangk\Downloads\logparser-main\logparser-main\logparser\DivLog\embeddings\Mac.json', "r")
    ...
    sampled_log = getDppIndex(log_embs, 2000, percentage)  #candidate_idx是一个列表
    print(sampled_log)
   # python dpp_tf.py --project "Mac" --shot 50
    ...
    save_path = "./logs/dpp_embedd/" + project + "/" + str(precentage) + "/"
